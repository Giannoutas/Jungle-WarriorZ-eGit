...
public class mainMenu extends JFrame{
    ...
    public mainMenu() {
    	...
    	//Ανάγνωση αρχείου για τον έλενχο της μουσικής.
    	readData();
        ...
        //Διαβάζει τις default επιλογές πλήκτρων που έγιναν στην main, και τις εκχωρεί σε ένα άλλο βοηθητικό αρχείο κειμένου.
	...
	// Διαβάζει τους κωδικόυς των πλήκτρων από ένα αρχείο και τα αποθηκεύει σε μια δομή δεδομένων.
	...
	//Γράφει σε ένα αρχείο τους κωδικούς των πλήκτρων που βρίσκονται σε μια δομή δεδομένων.
	...
	//Διαβάζει την επιλογή για τον ήχο.
	private void readData() {
		Scanner s = null;
		try {
			s = new Scanner(new BufferedReader(new FileReader("Texts/MusicMuted.txt")));
