...
public class SinglePlayerMenu extends JFrame{
	...
	public SinglePlayerMenu() {
        ...
        selectedCharacter = "Characters/Hero/Skin 1 Stand.png";
        ...
        labelPlayerPicture.setIcon(new ImageIcon("Characters/Hero/Skin 1 Stand.png"));
	...
	// Έλεγχος ποντικιού και απόκριση συμβάντων ποντικιού όσων αφορά την αλληλεπίδραση της λίστας με τους χαρακτήρες και της εμφάνισης αυτών.
        		...
        		int index = theList.locationToIndex(mouseEvent.getPoint());
          		if (index >= 0) {
            		...
            		if(o.toString().equals("Character 1")) {
            			...
            			selectedCharacter = "Characters/Hero/Skin 2 Stand.png";
            		}
	...
	public class MyRunner implements Runnable{
		  ...
		  public void run(){
				...
				game.run();
				System.out.println("fdfdffdfdgfdgfgd");
		  }
	...
	//Εγγραφή σε αρχείο κειμένου, την διεύθυνση του χαρακτήρα που επέλεξε ο χρήστης.
	private void writeDataToFile(String character){
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("Texts/SelectedCharacterText.txt"));
			out.write(character);
			out.close();
		} catch(IOException e) {
			e.printStackTrace();
