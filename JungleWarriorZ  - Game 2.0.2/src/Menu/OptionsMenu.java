...
public class OptionsMenu extends JFrame{
    ...
    public OptionsMenu() {
        ...
        //Παίρνει τις επιλογές ήχου για τα εφέ και την μουσική από τα ανάλογα αρχεία και τα αποθηκεύει στις αντίστοιχες μεταβλητές.
        soundMuted = readData("Texts/SoundMuted.txt");
        musicMuted = readData("Texts/MusicMuted.txt");
        ...
        //Έλενχος για να είναι τσεκαρισμένο το σωστό CheckBox.
	...
	// Έλεγχος ποντικιού και απόκριση συμβάντων ποντικιού όσων αφορά την αλληλεπίδραση της λίστας με την εμφάνιση του πλήκτρου στο defaultButtonTextField.
	...
	public class OptionButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource() == OKButton) {
				...
				//Οι όποιες αλλαγές αποθηκεύονται στα αρχεία.
				writeDataToFile("Texts/KeyCodeText.txt", listData);
				writeDataToFile("Texts/soundMuted.txt",soundMuted);
				writeDataToFile("Texts/MusicMuted.txt",musicMuted);
				if(musicMuted.equals("On")) {
				...
				//Οι αλλαγές δεν αποθηκεύονται στα αρχεία και γίνεται επιστροφή των προηγούμενων δεδομένων.
				readData("Texts/HelpKeyCodeText.txt", helpListData);
				writeDataToFile("Texts/KeyCodeText.txt", helpListData);
				optionsFrame.dispose();
				new mainMenu();
	...
	//Εγγραφή επιλογής ήχου για εφέ ή μουσικής σε κατάλληλο αρχείο.
	...
	//Διαβάζει την επιλογή για τον ήχο ή των εφέ ή της μουσικής και την επιστρέφη σε μορφή String.
