...
public class SinglePlayerMenu extends JFrame{
	...
	public SinglePlayerMenu() {
        ...
        selectedCharacter = "Content/Textures/Characters/Essay/Skin 1 Stand.png";
        ...
        labelPlayerPicture.setIcon(new ImageIcon("Content/Textures/Characters/Essay/Skin 1 Stand.png"));
        		...
        		int index = theList.locationToIndex(mouseEvent.getPoint());
          		if (index >= 0) {
            		...
            		if(o.toString().equals("Character 1")) {
            			...
            			selectedCharacter = "Content/Textures/Characters/Essay/Takis skin2.png";
	...
	private static void writeDataToFile(String nickname, String character, String soundFlag){
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("Texts/StartSinglePlayerText.txt"));
			out.write(nickname);
			out.newLine();
			out.write(character);
			out.newLine();
