...
public class Enemy extends Character
{
  ...
  public static Enemy createEnemy1(SpriteLoader spriteLoader, int tileX, int tileY)
  {
    ...
    enemyAnim.addFrame(spriteLoader.load("Content/Textures/Characters/Essay/Monster stand.png"));
    enemyAnim.addFrame(spriteLoader.load("Content/Textures/Characters/Essay/1.png"));
    enemyAnim.addFrame(spriteLoader.load("Content/Textures/Characters/Essay/1.png"));
    enemyAnim.addFrame(spriteLoader.load("Content/Textures/Characters/Essay/1.png"));
  ...
  public static Enemy createEnemy2(SpriteLoader spriteLoader, int tileX, int tileY)
  {
    //Load the frames into the animation
    AnimatedSprite enemyAnim = new AnimatedSprite(200f,true, true);
    enemyAnim.addFrame(spriteLoader.load("Content/Textures/Characters/Spider/walk1.png"));
    enemyAnim.addFrame(spriteLoader.load("Content/Textures/Characters/Spider/walk2.png"));
    enemyAnim.addFrame(spriteLoader.load("Content/Textures/Characters/Spider/dead.png"));
